...
if plotflag == 2
    ...
    hold on
    xlabel('number of terms', 'FontSize', fontSizeLabel, 'FontWeight', fontWeight)
    ylabel('Error |\Theta \xi|', 'FontSize', fontSizeLabel, 'FontWeight', fontWeight)
    title('Pareto front', 'FontSize', fontSizeTitle, 'FontWeight', fontWeight)
